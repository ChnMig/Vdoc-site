...
artifact_name="$(jq -r .artifact_name "$ROOT_DIR/workspace-distribution.json")"
artifact_one="$output_one/$artifact_name.tar.gz"
artifact_two="$output_two/$artifact_name.tar.gz"
